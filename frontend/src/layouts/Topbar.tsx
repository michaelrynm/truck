...
const Topbar = () => {
  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200/80 flex items-center justify-between px-6 shadow-sm">
      ...
      <div className="flex items-center space-x-4">
        {/* Role Badge */}
        <span className={`px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide rounded-md border ${getRoleBadgeColor(user?.role || '')}`}>
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center space-x-3 px-3 py-2 rounded-lg hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-200"
          >
            <div className="w-9 h-9 bg-gradient-to-br from-[#1e3a5f] to-[#152a45] rounded-full flex items-center justify-center shadow-sm">
