...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-[#1e3a5f] to-[#152a45] flex flex-col shadow-xl">
      {/* Logo/Brand Section */}
      <div className="h-16 flex items-center px-5 border-b border-[#2d4a6f]/50">
